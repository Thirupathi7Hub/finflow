...
```
finflow/
├── index.html              # Main HTML — full dashboard structure & layout
├── css/
│   └── style.css           # Complete design system, dark/light themes, responsive
├── js/
│   └── app.js              # All application logic, state management, rendering
├── data/
│   └── transactions.js     # 50 mock transactions (Jan–Apr 2025)
└── README.md
```
...
- **Monthly breakdown table** — Income, expense, net per month with visual progress bar
...
- **Sora** (display font) + **DM Sans** (body) — distinctive, readable pair
